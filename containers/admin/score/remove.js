...
import { scoreRemove } from "../../../store/actions/admin/user";
...
const PaymentAdd = ({ id }) => {
  ...
  const { activity, points, description, user } = formData.values;
  ...
  const handleClose = async () => {
    ...
    setOpen(false);
    dispatch(scoreRemove(user, { points, description, user, activity }));
