...
import { categoryAddChannel } from "../../../store/actions/admin/user";
...
const CategoryAddChannel = ({ id }) => {
  ...
  const handleClose1 = async () => {
    ...
    setOpen(false);
    dispatch(categoryAddChannel(id, formData.values));
    await setFormData({
      ...formData,
  ...
  return (
    <div>
      <Button onClick={handleClickOpen}>Add channel</Button>
      <Dialog
        open={open}
        onClose={handleClose}
...
export default CategoryAddChannel;
